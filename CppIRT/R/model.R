...
#' @description \code{\link{cppirt_model}} is an instance to estimate IRT. For the methods, see \code{\link{CppIRTModel}}.
#' 
...
#' }
#' 
#' @return A \code{\link{CppIRTModel}} object.
#' @export
#' 
#' @examples
#' \dontrun{
...
cppirt_model <- function(data, priors = list(), control = list()) {
  return(CppIRTModel$new(data = data, priors = priors, control = control))
}

#' CppIRTModel objects
#'
#' @name CppIRTModel
#' @description A \code{\link{CppIRTModel}} object is an \code{\link[R6]{R6Class}} object created
#'   by the \code{\link{cppirt_model}} function. 
#'
#' @importFrom R6 R6Class
#' @importFrom stats coef glm
#' @importFrom Rcpp sourceCpp
#' 
#' @useDynLib CppIRT, .registration = TRUE
#' 

CppIRTModel <- R6::R6Class(
  classname = "CppIRTModel",
  lock_objects = FALSE,
  public = list(
    
    #' @description Initialize the new instance of \code{\link{CppIRTModel}}.
    #' 
    #' @param data an I (individual) x J (item) matrix. This should contain 0 or 1.
    #' @param priors a list containing priors:
    #' \itemize{
